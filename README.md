...
Semantic HTML is HTML which has a function on the web page, and is not just for looks.
...
Git allows developers to collaborate and make changes on the same project at the same time.

5. Define mobile-first design in your own words.

building a webpage mobile first means that you build the page for phone screens (500px) and then go back and make the page responsive for desktop, using @media.
